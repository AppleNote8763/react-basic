...
// 쿠키 (Cookie)
// 클라이언트가 특정한 웹 서비스에 방문하여 사용중 해당 서비스에서 필요한 데이터를 클라이언트 부라우저에서 저장하는 기술
// - 이름, 값, 만료일, 도메인, 경로가 포함됨

// npm install react-cookie
export default function ReactCookie() {

    // uesCookies : 리액트에서 쿠키 객체, 쿠기 변경 함수, 쿠키 제거 함수를 배열로 반환하는 react-cookie의 훅 함수
    ...
    return (
        <div>
            ...
            <button onClick={onShowClickHandler}>쿠기 확인</button>
